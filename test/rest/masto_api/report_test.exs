...
defmodule Bonfire.API.MastoApi.ReportTest do
  @moduledoc """
  Tests for Mastodon-compatible Reports API endpoints.

  Run with: just test extensions/bonfire_api_graphql/test/rest/masto_api/report_test.exs
  """
