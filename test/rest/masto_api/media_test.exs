...
defmodule Bonfire.API.MastoApi.MediaTest do
  @moduledoc """
  Tests for Mastodon-compatible Media API endpoints.

  Run with: just test extensions/bonfire_api_graphql/test/rest/masto_api/media_test.exs
  """
